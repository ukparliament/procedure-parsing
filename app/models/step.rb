...
class Step < ActiveRecord::Base
  ...
  # ## A method to get all outbound routes from a step in the given procedure.
  ...
  # ## A method to get all inbound routes from a step in the given procedure.
  ...
  # # A method to get whether a step has been actualised by a business item in this work package having happened.
  ...
  # ## A method to get houses steps - the join between steps and Houses - for this step in the House of Commons.
  ...
  # ## A method to get houses steps - the join between steps and Houses - for this step in the House of Lords.
